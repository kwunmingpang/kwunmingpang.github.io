...
const FollowMe: FC<{ col?: boolean }> = ({ col = true }) => {
    return <div className={`flex flex-row ${col ? "md:flex-col" : ""} ${col ? "md:gap-2" : ""} gap-6`}>
        <div><a href="https://www.linkedin.com/in/kwun-ming-pang-6443a0181/"><LinkedIn className="fill-zinc-600 hover:fill-blue-300 cursor-pointer" /></a></div>
        <div><a href="https://github.com/kwunmingpang"><GithubMark className="fill-zinc-600 hover:fill-blue-300 cursor-pointer" /></a></div>
